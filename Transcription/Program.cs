...
namespace Transcription
{
    public class Program
    {
        ...
        public static async Task GetScript()
        {
            /*
            ProcessStartInfo startInfo = new ProcessStartInfo()
            {
                FileName = @"C:\Users\AynurV\PycharmProjects\asdsadasdsad\venv\Scripts\python.exe",
                Arguments = "C:/Users/AynurV/PycharmProjects/asdsadasdsad/main.py",
                WorkingDirectory = @"C:\Users\AynurV\PycharmProjects\asdsadasdsad",
